...
class ConfItem
{
 ...
 public:
  ...
  const string & ValueStringFull() const {return m_valueStringFull;}
  ...
  void SetValueFull(const string & s) {m_valueStringFull = s;}
...
class Config
{
 public:
  ...
  void GetFullValue(string & out, const string & key);
